...
import com.example.swadseva.MenuBottomSheetFragment
import com.example.swadseva.R
import com.example.swadseva.adapter.MenuAdapter
import com.example.swadseva.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun randomPopularItems() {
        //create aa shuffled list of new items
    ...
    private fun setPopularItemsAdapter(subsetMenuItems: List<MenuItem>) {
        ...
        binding.popuralRecyclerView.layoutManager= LinearLayoutManager(requireContext())
        binding.popuralRecyclerView.adapter = adaptar
    }
